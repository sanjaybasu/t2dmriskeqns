...
server = function(input, output) {
  ...
  mi_beta = reactive({round(100*(1-0.85^exp(0 + 
                                              ...
                                              0.4256 * as.numeric(input$sercreat)*0.9/78.6 + 
                                              0.001903 * as.numeric(input$totchol)*183.2/4.7 + 
                                              -0.008402 * as.numeric(input$hdlchol)*41.8/1.1 +
                                              0.1706 * as.numeric(input$hgba1c) +
                                              0.0003359 *as.numeric(input$uralbcreat)*99.2/11.3+
                                                -3.65)))
  })
